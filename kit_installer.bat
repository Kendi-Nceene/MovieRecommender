...
SET REPO_DOWNLOAD_URL=https://github.com/kandikits/MovieRecommender/releases/download/v1.0/MovieRecommender-master.zip
...
SET EXTRACTED_REPO_DIR=ovieRecommender-master
